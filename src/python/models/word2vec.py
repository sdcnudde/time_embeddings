...
from gensim_cust.utils import keep_vocab_item, call_on_class_only
from gensim_cust.models.keyedvectors import KeyedVectors, Vocab
...
from numpy import exp, log, dot, zeros, outer, random, get_include, dtype, float32 as REAL,\
    double, uint32, seterr, array, uint8, vstack, fromstring, sqrt, newaxis,\
    ndarray, empty, sum as np_sum, prod, ones, ascontiguousarray, vstack, logaddexp

from scipy.special import expit

from gensim_cust import utils, matutils  # utility fnc for pickling, common scipy operations etc
from gensim_cust.corpora.dictionary import Dictionary
...
from gensim_cust.models.word2vec_inner import train_batch_sg, score_sentence_sg, FAST_VERSION, MAX_WORDS_IN_BATCH
#pyximport.install()

from gensim_cust.models.word2vec_inner import train_batch_sg, train_batch_cbow
from gensim_cust.models.word2vec_inner import score_sentence_sg, score_sentence_cbow
from gensim_cust.models.word2vec_inner import FAST_VERSION, MAX_WORDS_IN_BATCH
try:
    from gensim_cust.models.word2vec_inner import train_batch_sg, train_batch_cbow
    from gensim_cust.models.word2vec_inner import score_sentence_sg, score_sentence_cbow
    from gensim_cust.models.word2vec_inner import FAST_VERSION, MAX_WORDS_IN_BATCH
        ...
        for sentence in sentences:
            ...
            for pos, word in enumerate(word_vocabs):
                ...
                for pos2, word2 in enumerate(word_vocabs[start:(pos + model.window + 1 - reduced_window)], start):
                    ...
                    if pos2 != pos:
                        print("Word 1: " + model.wv.index2word[word.index])
                        print("Word 2: " + model.wv.index2word[word2.index])
...
class Word2Vec(utils.SaveLoad):
    ...
    def __init__(
            self, sentences=None, dates=None, size=100, alpha=0.025, window=5, min_count=5,
        ...
        if sentences is not None:
            ...
            self.train(sentences, dates, total_examples=self.corpus_count, epochs=self.iter,
    ...
    def _do_train_job(self, sentences, dates, alpha, inits):
        """
        ...
        tally = 0
        if self.sg:
            tally += train_batch_sg(self, sentences, dates, alpha, work)
        else:
            tally += train_batch_cbow(self, sentences, dates, alpha, work, neu1)
    ...
    def train(self, sentences, dates, total_examples=None, total_words=None,
        ...
        def worker_loop():
            ...
            while True:
                ...
                sentences, alpha = job
                tally, raw_tally = self._do_train_job(sentences, dates, alpha, (work, neu1))
